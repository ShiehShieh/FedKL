...
def run(start, end, flag):
    ...
    if True:
       ...
       pairs10 = [
         ...
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-3-1e-4-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-3-1e-4-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-3-1e-4-initstate-ec-seed2.csv'], 'FedAvg', 'black', 'dotted'],
         ...
         [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-3-1e-2-_1e0-1e-1-50_-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-3-1e-2-_1e0-1e-1-50_-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-3-1e-2-_1e0-1e-1-50_-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', '-'],
       ...
       pairs10000 = [
         ...
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-2-1e-3-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-2-1e-3-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-2-1e-3-initstate-ec-seed2.csv'], 'FedAvg', 'black', 'dotted'],
         ...
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-2-1e-1-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-2-1e-1-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-2-1e-1-initstate-ec-seed2.csv'], 'FedAvg', 'black', '-'],
       ...
       pairs100000 = [
         # [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-3-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-3-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-3-initstate-ec-seed2.csv'], 'FedAvg', 'black', 'dotted'],
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-2-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-2-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-2-initstate-ec-seed2.csv'], 'FedAvg', 'black', 'dotted'],
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-2-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-2-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-2-initstate-ec-seed2.csv'], 'FedAvg', 'green', '-'],
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-5e-2-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-5e-2-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-5e-2-initstate-ec-seed2.csv'], 'FedAvg', 'red', '-'],
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-1-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-1-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e-1-initstate-ec-seed2.csv'], 'FedAvg', 'black', '-'],
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-1-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-1-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-1-initstate-ec-seed2.csv'], 'FedAvg', 'orange', '-'],
         # [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-2e-1-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-2e-1-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-2e-1-initstate-ec-seed2.csv'], 'FedAvg', 'black', '--'],
         # [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-1-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-1-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-3e-1-initstate-ec-seed2.csv'], 'FedAvg', 'black', '--'],
         [['fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e0-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e0-initstate-ec-seed1.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e0-initstate-ec-seed2.csv'], 'FedAvg', 'black', '-'],
         ## [['fedprox-nonlinear-reacherv2-3c-20iter-1e-1-1e-2-1e-1-initstate-ec-seed0.csv', 'fedprox-nonlinear-reacherv2-3c-20iter-1e-1-1e-2-1e-1-initstate-ec-seed1.csv', 'fedprox-nonlinear-reacherv2-3c-20iter-1e-1-1e-2-1e-1-initstate-ec-seed2.csv'], 'FedProx', 'orangered', '-'],
         ## [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-2-2e-1-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-2-2e-1-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-2-2e-1-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', 'dotted'],
         # [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-1-3e-1-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-1-3e-1-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-1-3e-1-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', '--'],
         # [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-1-4e-1-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-1-4e-1-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-1-4e-1-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', '-'],
         ## [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-3-1e-1-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-3-1e-1-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e-3-5e-2-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', '--'],
         [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-5e-1-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-5e-1-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-5e-1-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', '-'],
         [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-3e-1-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-3e-1-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-3e-1-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', 'dotted'],
         [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-4e-1-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-4e-1-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-4e-1-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', '--'],
         [['fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-_1e0-5e-1-10_-1e-4-initstate-ec-seed0.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-_1e0-5e-1-10_-1e-4-initstate-ec-seed1.csv', 'fedtrpo-nonlinear-reacherv2-3c-20iter-sqrt_kl-1e-1-1e0-_1e0-5e-1-10_-1e-4-initstate-ec-seed2.csv'], 'FedKL', 'dodgerblue', '-'],
       ]
       pairs1000000 = [
         [['fedavg-nonlinear-reacherv2-3c-50iter-1e-2-1e-1-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-50iter-1e-3-1e-2-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-50iter-1e-2-1e-3-initstate-ec-seed0.csv'], 'FedAvg', 'black', '-'],
         [['fedavg-nonlinear-reacherv2-3c-50iter-1e-2-1e-2-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-50iter-1e-3-1e-3-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e0-initstate-ec-seed2.csv'], 'FedAvg', 'black', '--'],
         [['fedavg-nonlinear-reacherv2-3c-50iter-1e-2-1e-3-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-50iter-1e-3-1e-4-initstate-ec-seed0.csv', 'fedavg-nonlinear-reacherv2-3c-20iter-1e-1-1e0-initstate-ec-seed2.csv'], 'FedAvg', 'black', 'dotted'],
       ]
       pairs11 = [
       ...
       tasks = [
           ...
           #
           [[[p[0][0:3]] + p[1:] for p in pairs10], ax1, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed0'],
           [[[p[0][0:3]] + p[1:] for p in pairs100], ax2, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed1'],
           [[[p[0][0:3]] + p[1:] for p in pairs100000], ax3, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed2'],
           [[[p[0][0:1]] + p[1:] for p in pairs1000000], ax4, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed2'],
           [[[p[0][1:2]] + p[1:] for p in pairs1000000], ax5, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed2'],
           [[[p[0][2:3]] + p[1:] for p in pairs1000000], ax6, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed2'],
           [[[p[0][0:1]] + p[1:] for p in pairs100000], ax7, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed2'],
           [[[p[0][1:2]] + p[1:] for p in pairs100000], ax8, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed2'],
           [[[p[0][2:3]] + p[1:] for p in pairs100000], ax9, (0.0, 300.0), (-30.0, -9.0), 'Reacher-v2 init-state seed2'],
       ]
       for task in tasks:
           pairs = task[0]
           ax = task[1]
