...
O-nonlinear-1e-4-5e-1'], loc='best')
    ...
    if group5:
      fedavg_nonlinear_14 = load_data('fedavg-nonlinear-1e-4.csv')
      fedprox_nonlinear_14_11 = load_data('fedprox-nonlinear-1e-4-1e-1.csv')
      fedtrpo_nonlinear_14_31 = load_data('fedtrpo-nonlinear-tv-1e-4-3e-1.csv')
      fedtrpo_nonlinear_14_51 = load_data('fedtrpo-nonlinear-tv-1e-4-5e-1.csv')

      fedavg_nonlinear_14 = fedavg_nonlinear_14[start:end]
      fedprox_nonlinear_14_11 = fedprox_nonlinear_14_11[start:end]
      fedtrpo_nonlinear_14_31 = fedtrpo_nonlinear_14_31[start:end]
      fedtrpo_nonlinear_14_51 = fedtrpo_nonlinear_14_51[start:end]

      h14, = plt.plot(range(len(fedavg_nonlinear_14)), fedavg_nonlinear_14)
      h15, = plt.plot(range(len(fedprox_nonlinear_14_11)), fedprox_nonlinear_14_11)
      h17, = plt.plot(range(len(fedtrpo_nonlinear_14_31)), fedtrpo_nonlinear_14_31)
      h18, = plt.plot(range(len(fedtrpo_nonlinear_14_51)), fedtrpo_nonlinear_14_51)
      plt.legend(handles=[h14, h15, h17, h18], labels=['FedAvg-nonlinear-1e-4', 'FedProx-nonlinear-1e-4-1e-1', 'FedTRPO-nonlinear-1e-4-3e-1', 'FedTRPO-nonlinear-1e-4-5e-1'], loc='best')
